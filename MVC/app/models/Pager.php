                ...
                <nav class="<?=$this->nav_class?>" style="<?=$this->nav_styles?>">
                    <ul class="<?=$this->ul_class?>"style="<?=$this->ul_styles?>">
                        <li class="<?=$this->li_class?>" style="<?=$this->li_styles?>">
                             <a class="<?=$this->a_class?>" style ="<?=$this->a_styles?>" href="<?=$this->links['first']?>">First</a></li>
                        <?php for($x = $this->start; $x <= $this->end; $x++):?>
                            <li class="<?=$this->li_class?>" style="<?=$this->li_styles?> <?=($x == $this->page_number)?'active':'';?>">
                                <a class="<?=$this->a_class?>" style="<?=$this->a_styles?>" href="<?= preg_replace('/page=[0-9]+/',"page=".$x,$this->links['current'])?>"><?=$x?></a>
                            </li>
                        <?php endfor;?>
                        <li class="<?=$this->li_class?>" style="<?=$this->li_styles?>"> <a class="<?=$this->a_class?>" style="<?=$this->a_styles?>" href="<?=$this->links['next']?>">Next</a></li>
                    </ul>
                </nav>
            </div>
            <?php
